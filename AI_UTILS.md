...
| ------------------------------ | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cooldowns.ts`                 | F1, F4, F13 | Major CD extraction, panic/overlap detection, Early/Optimal/Late/Reactive timing labels. Contains `PANIC_PRESS_DAMAGE_THRESHOLD_*` constants (⚠️ patch-volatile — calibrated from benchmark data). Current Healer threshold: 35k (calibrated 2026-04-08). |

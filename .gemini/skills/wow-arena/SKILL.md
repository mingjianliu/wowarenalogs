...
Update static WoW data (spells, talents, archetypes) and refine arena geometry maps. At season start, run the full refresh checklist.

- **References**: [season-refresh.md](../../../docs/commands/season-refresh.md), [update-wow-data.md](../../../docs/commands/update-wow-data.md), [refine-arena-geometry.md](../../../docs/commands/refine-arena-geometry.md)

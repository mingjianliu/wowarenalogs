...
export type NativeApi = {
  logs?: {
    ...
    handleBattlegroundEnded?: (callback: AsEventFunction<LogsModule['handleBattlegroundEnded']>) => void;
    removeAll_handleBattlegroundEnded_listeners?: () => void;
  ...
  obs?: {
    ...
    startBuffer?: OmitFirstArg<ObsModule['startBuffer']>;
    stopRecordingEngine?: OmitFirstArg<ObsModule['stopRecordingEngine']>;

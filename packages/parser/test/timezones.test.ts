...
describe('parsing timezones', () => {
  it('should parse negative tzs 4', () => {
    const log =
  ...
  it('should parse negative tzs 11', () => {
    const log =
  ...
  it('should parse positive tzs 0', () => {
    const log =
  ...
  it('should parse positive tzs 12', () => {
    const log =
  ...
  it('should parse timestamps without embedded offsets using the provided timezone', () => {
    const log =
    ...
    expect((logLine as unknown as ILogLine).timestamp).toBe(
      moment.tz('2024-05-10 20:50:33.984', 'YYYY-MM-DD HH:mm:ss.SSS', 'America/New_York').valueOf(),
    );
  });
});
